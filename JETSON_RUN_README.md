# Jetson Nano Test Run Commands

Jetson Nano에서 `student02` namespace로 CPU/GPU 실험을 실행하는 명령 모음이다.
...
```text
/root/catkin_ws/src/cartographer_parallel/cartographer_parallel/results/
```

각 실행 명령의 `perf_csv_file` 값으로 지정한 파일에 저장된다.

예:

```text
/root/catkin_ws/src/cartographer_parallel/cartographer_parallel/results/cpu_baseline_perf.csv
/root/catkin_ws/src/cartographer_parallel/cartographer_parallel/results/test4_gpu_block_cached_map_shared_perf.csv
```
